...
try{
	webWorkerApply=new Worker('../patcher/js/worker_apply.js');
	...
	webWorkerCreate=new Worker('../patcher/js/worker_create.js');
	...
	webWorkerCrc=new Worker('../patcher/js/worker_crc.js');
...
addEvent(window,'load',function(){
	...
	if(CAN_USE_WEB_WORKERS){
		...
		zip.workerScriptsPath='../patcher/js/zip.js/';
	}else{
