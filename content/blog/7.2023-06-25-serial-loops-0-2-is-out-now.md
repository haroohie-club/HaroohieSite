...
* Added the ability to build your hack through a local docker container
* Added script templates that make it easier to get started editing scripts with common layouts
...
In addition, a number of bug and crash fixes and general program stability improvements (particularly related to the script editor) have been made for a better and more stable experience!