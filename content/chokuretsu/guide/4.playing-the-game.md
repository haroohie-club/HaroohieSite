...
4. Select the following options:
    ...
    - On the "Icon Image" box, click "Create File". Download this image (or use your own) and choose it under "Select File". Feel free to customise the appearance, this is the icon that will appear on your Wii U system menu. Then, click "Finish"
